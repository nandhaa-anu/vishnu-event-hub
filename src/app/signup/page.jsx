    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-8">
            <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-xl shadow-lg">
                <h2 className="text-3xl font-black text-center text-gray-900 dark:text-white uppercase tracking-tighter">
                    Initialize <span className="text-blue-500">Node</span>
                </h2>
                <div className="space-y-4">
                    <input
                        placeholder="Name"
                        className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-transparent dark:text-white focus:ring-2 focus:ring-blue-500 outline-none"
