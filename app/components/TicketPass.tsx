    ...
    return (
        <div className="flex flex-col items-center gap-8 py-10 px-6">
            ...
            >
                ...
                <div className="absolute -inset-0.5 bg-gradient-to-r from-accent-blue via-accent-violet to-pink-500 rounded-[2.5rem] blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>

                <div className="relative glass-card rounded-[2.5rem] overflow-hidden flex flex-col bg-[#0B0F1A]/80 backdrop-blur-3xl border border-white/10">
                    ...
                    <div className="px-8 py-6">
                        ...
                        <div className="py-6 border-y border-white/5 relative">
                            ...
                            <p className="text-lg font-black text-gradient leading-tight mb-1">{eventName}</p>
